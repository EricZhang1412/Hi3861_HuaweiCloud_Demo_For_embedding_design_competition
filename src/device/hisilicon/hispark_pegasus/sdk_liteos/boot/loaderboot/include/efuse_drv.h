...
#define EFUSE_WRITE_READY_STATUS (1 << 0)
#define EFUSE_READ_READY_STATUS  (1 << 1)
#define EFUSE_STATUS_MASK        (0x7 << 2)
#define EFUSE_PO_STATUS_READY    (0x1 << 2)
#define EFUSE_STATUS_READY       (0x1 << 4)
...
#define EFUSE_TIMEOUT_DEFAULT 1000000
